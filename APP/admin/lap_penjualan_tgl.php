...
$pdf->Image('../logo/Indogamestore.png',1,1,2,2);
$pdf->SetX(4);            
...
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. KIOS Indogamestore',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : www.Indogamestore.com email : Indogamestore@gmail.com',0,'L');
...
$query=mysqli_query($con,"select * from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
...
$q=mysqli_query($con,"select sum(total_harga) as total from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
...
$qu=mysqli_query($con,"select sum(laba) as total_laba from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
